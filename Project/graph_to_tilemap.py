...
tiled_map = {
    ...
    "nextlayerid": 3,
    "nextobjectid": 1,
    # Minimal tileset reference.
    # If you have an external .tsx tileset, replace this dict with:
    #   {"firstgid": 1, "source": "your_tileset.tsx"}
    "tilesets": [
        {
            "firstgid": 1,
            "name": "Tileset",
            ...
            # ↓ Point this at your actual tileset image
            "image": "data/sprites/sprite.png",
        }
    ],
    "layers": [
        {
